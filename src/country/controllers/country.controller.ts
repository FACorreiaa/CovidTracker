...
export class CountryController {
  ...
  @Get('total/:country')
  async findWIPbyDate(@Param('country') country: string) {
  ...
  async findCountryTotalByCountry(
    ...
    return await this.countryService.findCountryTotalByCountry(
      country,
      status,
      from,
      to,
  ...
  async findTotalByCountryAllStatus(
    ...
    return await this.countryService.findTotalByCountryAllStatus(
      country,
      status,
      from,
      to,
  ...
  async findTotalByCountry(
    ...
    return await this.countryService.findTotalByCountry(
      country,
      status,
      from,
      to,
